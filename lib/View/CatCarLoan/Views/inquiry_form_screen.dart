...
class InquiryFormScreenCarLoans extends StatefulWidget {
  const InquiryFormScreenCarLoans({Key? key}) : super(key: key);

  @override
  State<InquiryFormScreenCarLoans> createState() =>
      _InquiryFormScreenCarLoansState();
}

class _InquiryFormScreenCarLoansState extends State<InquiryFormScreenCarLoans> {
