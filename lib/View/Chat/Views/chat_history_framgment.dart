...
import 'package:otobucks/View/Chat/Controllers/chat_screen_controller.dart';
              ...
              children: [
                          ...
                          Container(
                              ...
                              child: Text(
                                ...
                                style: AppStyle.textViewStyleNormalBodyText2(
                                    context: context, color: AppColors.colorWhite, fontSizeDelta: 0, fontWeightDelta: 0),
                              )),
                          Container(
                              alignment: Alignment.centerLeft,
                              child: Text(
                ...
                ListView.separated(
                    ...
                    padding: const EdgeInsets.only(
                        right: AppDimens.dimens_18, left: AppDimens.dimens_18, top: AppDimens.dimens_10, bottom: AppDimens.dimens_10),
                    ...
                    itemBuilder: (BuildContext contextM, index) {
                      ...
                      for (var roomUser in roomModel.users) {
                        if (roomUser.id != Get.find<HomeScreenController>().userId) {
                          user = roomUser;
                          break;
                        }
                      }
                            ...
                            children: [
                              Container(
                                ...
                                child: ClipRRect(
                                  borderRadius: BorderRadius.circular(AppDimens.dimens_50),
                                  child: NetworkImageCustom(
                                      image: user.image, fit: BoxFit.fill, height: AppDimens.dimens_34, width: AppDimens.dimens_34),
                                ),
                              ),
                              Expanded(
                                  child: Column(
                                      ...
                                      child: Row(
                                        children: [
                                          Expanded(
                                            ...
                                            style: AppStyle.textViewStyleNormalBodyText2(
                                                context: context, color: AppColors.colorBlack, fontSizeDelta: 0, fontWeightDelta: 0),
                                          )),
                                          Text(
                                            Global.getTimeFormat(roomModel.getDateInFormate().toString().split(' ')[1]),
                                            style: AppStyle.textViewStyleNormalBodyText2(
                                    ...
                                    children: [
                                      Expanded(
                                        child: Container(
                                            alignment: Alignment.centerLeft,
                                            child: Text(
                                              roomModel.serverChatModel == null ? '' : roomModel.serverChatModel!.message,
                                              style: AppStyle.textViewStyleSmall(
                                                  context: context, color: AppColors.grayDashboardText, fontSizeDelta: -1, fontWeightDelta: 0),
                                            )),
                                      ),
                                      roomModel.serverChatModel != null
                                          ? roomModel.serverChatModel!.from.id == Get.find<HomeScreenController>().userId
                                              ? const SizedBox.shrink()
                                              : roomModel.unReadMessages.toString() == '0'
                                                  ? Container()
                                                  : CircleAvatar(
                                                      radius: 8,
                                                      backgroundColor: AppColors.colorGreen,
                                                      child: Text(
                                                        roomModel.unReadMessages.toString(),
                                                        style: regularText(12).copyWith(color: Colors.white),
                                                      ),
                                                    )
                                          : const SizedBox.shrink()
                                    ],
