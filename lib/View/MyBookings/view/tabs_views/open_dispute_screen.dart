                  ...
                  return Stack(
                    ...
                    children: [
                      Container(
                        ...
                        child:
                        logic.selectDisputeImage.isEmpty ? InkWell(
                          onTap: () {
                          ...
                          File(controller.selectDisputeImage), fit: BoxFit.cover,),
                      ),
                      //Delete image
                      IconButton(onPressed: (){
                        logic.selectDisputeImage='';
                        logic.update();
                      }, icon:Icon( Icons.delete_outline,color: Colors.red,size: 27,))
                    ],
                  );
                })
          ],
        ...
        child: CustomButton(
            ...
            onPressed: () {
              Get.defaultDialog(
                  ...
                  onConfirm: () {
                    controller.openDispute(bookingID);
