...
import 'package:otobucks/controllers/category_screens_controllers/accessories/accessories_sub_cat_controller.dart';
import 'package:otobucks/controllers/dashboard_controller/dashboard_controller.dart';
import 'package:otobucks/fragment/categoryScreens/accessories_screens/components/searched_products.dart';
import 'package:otobucks/fragment/categoryScreens/accessories_screens/components/shop_item_component.dart';
...
class AccessoriesSubCatScreen extends StatefulWidget {
  ...
  @override
  State<AccessoriesSubCatScreen> createState() =>
      _AccessoriesSubCatScreenState();
}
  ...
  void initState() {
    ...
    Get.find<DashboardController>().controllerSearch.addListener(() {
      controller.onChangeSearch(
          Get.find<DashboardController>().controllerSearch.text);
    });
    super.initState();
  }
