...
class GetProviderBooking {
  ...
  factory GetProviderBooking.fromJson(Map<dynamic, dynamic> json) {
    return GetProviderBooking(
        providerId: json['provider']['_id'].toString(),
        bookingId: json['_id'].toString());
  }
}

class BookingRepo {
  Future<Either<Failure, Success>> getBookingByEstimation(
    ...
    try {
      String response = await ReqListener.fetchPost(
          strUrl: 'bookings/getBookingByEstimateId/$estimateId',
  ...
  Future<Either<Failure, Success>> getBookings(
  ...
  Future<Either<Failure, Success>> cancleBookings(
      HashMap<String, Object> requestParams, String estimateId) async {
    bool connectionStatus = await ConnectivityStatus.isConnected();
    if (!connectionStatus) {
      return Left(Failure(
    ...
    try {
      String response = await ReqListener.fetchPost(
          strUrl: 'estimates/cancel/$estimateId',
          requestParams: requestParams,
